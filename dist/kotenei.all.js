 ...
 * @author:kotenei(kotenei@qq.com)
 */
define('kotenei/magnifier', ['jquery'], function ($) {
 ...
 * @author:kotenei(kotenei@qq.com)
 */
define('kotenei/rating', ['jquery', 'kotenei/event'], function ($, event) {
